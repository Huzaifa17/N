...
def dashboard():
    ...
    topics_page = request.args.get('topics_page', 1, type=int)  # Get the current page number for topics
    topics_per_page = 5  # Number of topics per page
    ...
    profiles_page = request.args.get('profiles_page', 1, type=int)  # Get the current page number for profiles
    profiles_per_page = 5  # Number of profiles per page
    profiles_skip = (profiles_page - 1) * profiles_per_page  # Define profiles_skip here
    ...
    all_users = list(users.aggregate([
        ...
        {
            '$skip': profiles_skip  # Use profiles_skip here
        },
        {
            '$limit': profiles_per_page  # Use profiles_per_page here
        }
    ]))
